...
# -*- coding: utf-8 -*-
"""
Created on Sun Mar 19 12:34:32 2017
...
#Let us remove outliers in the data
...
# Price/bdr #
train_df["Price_bedroom"]=train_df["price"]/train_df["bedrooms"]
test_df["Price_bedroom"]=test_df["price"]/test_df["bedrooms"]
...
# Let us extract some features from date columns #
...
train_df['weekend'] = train_df['weekend'].apply(lambda x: 1 if x else 0)
test_df['weekend'] = ((test_df['weekday'] == 5) & (test_df['weekday'] == 6))
test_df['weekend'] = test_df['weekend'].apply(lambda x: 1 if x else 0)

# adding all these new features to use list #
features_to_use.extend(["Price_bedroom"],["num_photos", "num_features", "num_description_words","created_year", "created_month", "created_day", "listing_id", "created_hour", "weekday", "quarter", "weekend"])


# let us label encode categorical features in our data
...
out_df.to_csv("josh8.csv", index=False)
